...
function Join() {
  ...
  return (
    <Element id="Join" name="join">
      <div className="hero  min-h-screen  px-10 pt-20 pd-10 flex flex-col gap-10   bg-base-200">
        <h1 className="text-6xl font-extrabold">Turn your words into leads</h1>
        <p className="text-sm text-center">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facere
          dolorum alias quo eaque deserunt quas tempore animi, maiores
          voluptatum. Beatae laudantium veniam soluta numquam molestiae natus
          voluptatibus quia culpa corrupti.
        </p>
