...
export const Hero1 = () => {
  ...
  return (
    <div className="bg-base-100   flex text-center flex-col items-center justify-between  px-4   md:h-screen max-w-screen md:px-0">
      <Navbar />
      <div className="flex flex-col mt-16 items-center max-w-2xl md:px-8">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          <h1 className="max-w-lg text-5xl mb-6 text-base-content font-sans md:text-7xl font-bold leading-none tracking-tight  sm:text-4xl md:mx-auto">
            Start <span className="text-secondary">marketing</span> before building with 1 click
          </h1>
          <p className="text-base-content md:text-lg">
            Gain organic traffic to you business with help of AI generated blogs that runs on automation.
          </p>
        </div>
